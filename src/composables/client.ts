...
export function Environment(name: string): BaseURL {
    return `https://${name}-7ttse.encr.app`
}
...
/**
 * Client is an API client for the 7ttse Encore application.
 */
...
export namespace prompt {
    ...
    export class ServiceClient {
        ...
        public async analyze(params: BusinessInfoRequest): Promise<BusinessInfoResponse> {
            ...
            const resp = await this.baseClient.callTypedAPI("POST", `/business-info`, JSON.stringify(params))
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if ( typeof globalThis === "object" && !("window" in globalThis) ) {
            this.headers["User-Agent"] = "7ttse-Generated-TS-Client (Encore/v1.46.18)";
        }
